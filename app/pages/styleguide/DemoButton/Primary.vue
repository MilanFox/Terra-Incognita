<template>
  <div>
    <h1>DemoButton - Primary</h1>

    <Playground
      v-for="[title, props] in variants"
      :key="title"
      :title="title"
...
const variants: [string, Record<string, unknown>][] = [
  ['Small', { label: 'Click me', size: 'sm', variant: 'primary' }],
  ['Medium', { label: 'Click me', size: 'md', variant: 'primary' }],
  ['Large', { label: 'Click me', size: 'lg', variant: 'primary' }],
];
</script>
